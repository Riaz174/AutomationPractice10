...
public class Utilities {
  ...
  @BeforeMethod
  public void Browsers(String browsers, String Wbsite) throws InterruptedException {
	  ...
	  Thread.sleep(6000);
		  ...
		  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository19\\AutomationPractice10\\Drivers\\msedgedriver.exe");
  ...
  public void shots() throws IOException {
	  ...
	  FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository19\\AutomationPractice10\\Pictures\\"+sd+"pictureofwebsite.jpg"));
	//some updates
  }
